...
async def gpt_dialog(update, context):
    ...
    answer = await chatgtp.send_question(prompt_text=prompt, message_text=text)  # зберігаємо відповідь ШІ у змінну
...
dialog.mode = None  # Додаємо новий атрибут mode до об'єкту dialog та призначаємо йому значення None

chatgtp = ChatGptService(token=AI_TOKEN)
